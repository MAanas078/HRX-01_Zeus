...
function activate(context) {
    console.log(
        "Welcome, your extension CoolX is now activated! Sharing files just got easy 🎉"
    );
    ...
    vscode.window
        .showInformationMessage(
            "Welcome, CoolX is ready! Sharing files just got easy 🎉",
            "Get Started",
            "Dismiss"
        )
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand("CoolX-for-vscode.sendFileCmd", () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand(
            "CoolX-for-vscode.receiveFileCmd",
            () => {
